...
const Hero = () => {
  ...
  const downloadCV = () => {
    ...
    link.href = '/Images/Sushma-Resume.pdf';
  link.download = 'SushmaPotnuru_Resume.pdf'; 
...
<span className="text-primary-glow">
  Software Engineering Student
        ...
        <p ref={subtitleRef} className="text-lg md:text-xl text-muted-foreground mb-8 max-w-2xl mx-auto leading-relaxed">
         B.Tech engineering student (2028) passionate about software development, problem-solving, and building projects using C, Python, and web technologies.
        </p>
